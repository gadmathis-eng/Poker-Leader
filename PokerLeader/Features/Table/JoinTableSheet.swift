    ...
    var body: some View {
        NavigationStack {
            Form {
                ...
                Section {
                    Text("Ask the host for their table link or code. You don't need to add them as a friend — the code is enough. Before you sit, you'll choose how much to put in.")
                        .font(.caption)
